<div id="main-wrapper">
<?php $this->load->view('umum/V_topbar_lab_bakteri') ?>
<?php $this->load->view('umum/V_sidebar_lab_bakteri') ?>
...
<form  id="fileForm" method="post" action="<?php echo base_url('Lab_bakteri/simpan_hasil_uji') ?>">
...
<div class="row">
    ...
    <input type="text" name="hasil_bakteri" placeholder="hasil uji" class="form-control hasil_bakteri required" accept="text/plain">
    <label>Jumlah</label> 
    ...
    <input type="text" name="metode_bakteri" placeholder="metode jamur" class="form-control metode_bakteri  required" accept="text/plain">
</div>
</div>
...
<button class='btn btn-success btn-block selesai_bakteri'>Selesaikan Hasil Uji <span class='fa fa-save'></span></button>
</div>       
</div>
</div>
</div>
...
processing: true,
serverSide: true,
ajax: {"url": "<?php echo base_url('Lab_bakteri/json_data_pekerjaan/Proses') ?> ", 
"type": "POST",
data: function ( d ) {
...
formData.append('hasil_bakteri',$(".hasil_bakteri").val()),
formData.append('jumlah_uji',$(".jumlah_uji").val()),
formData.append('metode_bakteri',$(".metode_bakteri").val()),
...
$(document).ready(function(){
$(".selesai_bakteri").click(function(){
 ...
 Swal.fire({
  ...
  if (result.value) {
     ...
     $.ajax({
         ...
         url:"<?php echo base_url('Lab_bakteri/selesai_bakteri')  ?>",
         success:function(){
    Swal.fire(
      'Terselesaikan!',
      'success'
